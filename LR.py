...
#stopwords = ["election2016", "trump", "clinton", "republican", "democrat", "presidential", "politics", "debate", "poll", "delegate", "voters", "sanders", "donald", "cruz", "bernie", "hillary", "candidate", "ted", "campaign", "caucus"]
tweets = []
for line in open('training.txt').readlines():
...
f = open('HW8_Q1_LR_predictions.txt', 'w')
