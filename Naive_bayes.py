...
pos_tweets = read_tweets('Bernie_Positive_tweets.txt', 'positive')
neg_tweets = read_tweets('Bernie_Negative_tweets.txt', 'negative')
...
test_tweets = read_tweets('Bernie_NYC.txt','positive')
#test_tweets.extend(read_tweets('Bernie_NYC.txt', 'negative'))
